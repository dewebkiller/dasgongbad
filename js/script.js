...
$(window).load(function () {
  ...
  $(".single-tribe_events .tribe-events-event-cost")
    .after(
      "<p class='cost-desc'>(no one turned away for lack of money. To reserve your space with sliding scale, contact us here)(<a href='mailto:info@dasgongbad.com'>info@dasgongbad.com</a>)</p>"
    )
    .show();
